...
public class TopicBBSManager extends BaseBBSManager
{
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar)
	{
		if (ar1.equals("crea"))
		{
			...
			if (f == null)
			{
				CommunityBoardHandler.separateAndSend("<html><body><br><br><center>论坛: " + ar2 + " 尚未开放</center><br><br></body></html>", activeChar);
			}
			else
			{
				f.vload();
		...
		else if (ar1.equals("del"))
		{
			...
			if (f == null)
			{
				CommunityBoardHandler.separateAndSend("<html><body><br><br><center>论坛: " + ar2 + " 不存在 !</center><br><br></body></html>", activeChar);
			}
			else
			{
				...
				if (t == null)
				{
					CommunityBoardHandler.separateAndSend("<html><body><br><br><center>主题: " + ar3 + " 不存在 !</center><br><br></body></html>", activeChar);
				}
				else
				{
					// CPost cp = null;
		...
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>功能: " + ar1 + " 尚未开放</center><br><br></body></html>", activeChar);
		}
	}
	...
	public void parsecmd(String command, L2PcInstance activeChar)
	{
		...
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>the 功能: " + command + " 尚未开放</center><br><br></body></html>", activeChar);
		}
	}
	...
	private void showNewTopic(Forum forum, L2PcInstance activeChar, int idf)
	{
		if (forum == null)
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>论坛: " + idf + " 尚未开放</center><br><br></body></html>", activeChar);
		}
		...
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>论坛: " + forum.getName() + " 尚未开放</center><br><br></body></html>", activeChar);
		}
	}
	...
	{
		forum.vload();
		final StringBuilder html = StringUtil.startAppend(2000, "<html><body><br><br><table border=0 width=610><tr><td width=10></td><td width=600 align=left><a action=\"bypass _bbshome\">首页</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">备忘录列表</a></td></tr></table><img src=\"L2UI.squareblank\" width=\"1\" height=\"10\"><center><table border=0 cellspacing=0 cellpadding=2 bgcolor=888888 width=610><tr><td FIXWIDTH=5></td><td FIXWIDTH=415 align=center>&$413;</td><td FIXWIDTH=120 align=center></td><td FIXWIDTH=70 align=center>&$418;</td></tr></table>");
		...
		StringUtil.append(html, "</tr></table> </td> <td align=right><button value = \"&$421;\" action=\"bypass _bbstopics;crea;", String.valueOf(forum.getID()), "\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\" ></td></tr><tr><td><img src=\"l2ui.mini_logo\" width=5 height=10></td></tr><tr> <td></td><td align=center><table border=0><tr><td></td><td><edit var = \"搜索\" width=130 height=11></td><td><button value=\"&$420;\" action=\"Write 5 -2 0 Search _ _\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\"> </td> </tr></table> </td></tr></table><br><br><br></center></body></html>");
