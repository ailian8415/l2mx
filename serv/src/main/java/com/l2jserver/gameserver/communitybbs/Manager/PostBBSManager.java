...
public class PostBBSManager extends BaseBBSManager
{
	...
	public void parsecmd(String command, L2PcInstance activeChar)
	{
		...
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>" + command + " 功能尚未实装</center><br><br></body></html>", activeChar);
		}
	}
	...
	private void showEditPost(Topic topic, Forum forum, L2PcInstance activeChar, int idp)
	{
		if (topic == null)
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>错误: 主题不存在!</center></body></html>", activeChar);
		}
		else
		{
			...
			{
				CommunityBoardHandler.separateAndSend("<html><body><br><br><center>错误: 这个论坛或帖子不存在!</center></body></html>", activeChar);
			}
			else
			{
	...
	private void showPost(Topic topic, Forum forum, L2PcInstance activeChar, int ind)
	{
		...
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>错误: 这个论坛尚未开放!</center></body></html>", activeChar);
		}
		...
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>论坛: " + forum.getName() + " 尚未开放!</center></body></html>", activeChar);
		}
	}
	
	private void showHtmlEditPost(Topic topic, L2PcInstance activeChar, Forum forum, Post p)
	{
		final String html = StringUtil.concat("<html><body><br><br><table border=0 width=610><tr><td width=10></td><td width=600 align=left><a action=\"bypass _bbshome\">首页</a>&nbsp;>&nbsp;<a action=\"bypass _bbsmemo\">", forum.getName(), " 列表</a></td></tr></table><img src=\"L2UI.squareblank\" width=\"1\" height=\"10\"><center><table border=0 cellspacing=0 cellpadding=0><tr><td width=610><img src=\"sek.cbui355\" width=\"610\" height=\"1\"><br1><img src=\"sek.cbui355\" width=\"610\" height=\"1\"></td></tr></table><table fixwidth=610 border=0 cellspacing=0 cellpadding=0><tr><td><img src=\"l2ui.mini_logo\" width=5 height=20></td></tr><tr><td><img src=\"l2ui.mini_logo\" width=5 height=1></td><td align=center FIXWIDTH=60 height=29>&$413;</td><td FIXWIDTH=540>", topic.getName(), "</td><td><img src=\"l2ui.mini_logo\" width=5 height=1></td></tr></table><table fixwidth=610 border=0 cellspacing=0 cellpadding=0><tr><td><img src=\"l2ui.mini_logo\" width=5 height=10></td></tr><tr><td><img src=\"l2ui.mini_logo\" width=5 height=1></td><td align=center FIXWIDTH=60 height=29 valign=top>&$427;</td><td align=center FIXWIDTH=540><MultiEdit var =\"内容\" width=535 height=313></td><td><img src=\"l2ui.mini_logo\" width=5 height=1></td></tr><tr><td><img src=\"l2ui.mini_logo\" width=5 height=10></td></tr></table><table fixwidth=610 border=0 cellspacing=0 cellpadding=0><tr><td><img src=\"l2ui.mini_logo\" width=5 height=10></td></tr><tr><td><img src=\"l2ui.mini_logo\" width=5 height=1></td><td align=center FIXWIDTH=60 height=29>&nbsp;</td><td align=center FIXWIDTH=70><button value=\"&$140;\" action=\"发帖 ", String.valueOf(forum.getID()), ";", String.valueOf(topic.getID()), ";0 _ Content Content Content\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\" ></td><td align=center FIXWIDTH=70><button value = \"&$141;\" action=\"bypass _bbsmemo\" back=\"l2ui_ch3.smallbutton2_down\" width=65 height=20 fore=\"l2ui_ch3.smallbutton2\"> </td><td align=center FIXWIDTH=400>&nbsp;</td><td><img src=\"l2ui.mini_logo\" width=5 height=1></td></tr></table></center></body></html>");
	...
	public void parsewrite(String ar1, String ar2, String ar3, String ar4, String ar5, L2PcInstance activeChar)
	{
		...
		if (f == null)
		{
			CommunityBoardHandler.separateAndSend("<html><body><br><br><center>论坛: " + idf + " 不存在 !</center><br><br></body></html>", activeChar);
		}
		else
		{
			...
			if (t == null)
			{
				CommunityBoardHandler.separateAndSend("<html><body><br><br><center>主题: " + idt + " 不存在 !</center><br><br></body></html>", activeChar);
			}
			else
			{
				...
				if (p != null)
				{
					...
					if (cp == null)
					{
						CommunityBoardHandler.separateAndSend("<html><body><br><br><center>帖子: " + idp + " 不存在 !</center><br><br></body></html>", activeChar);
					}
					else
					{
