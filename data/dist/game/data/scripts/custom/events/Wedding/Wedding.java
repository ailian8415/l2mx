		...
		switch (event)
		{
			...
			case "accept":
			{
				...
				else
				{
					...
					player.sendMessage("¹§Ï²ÄãÃÇ½á»éÁË!");
					player.setMarried(true);
					player.setMarryRequest(false);
					partner.sendMessage("¹§Ï²ÄãÃÇ½á»éÁË!");
					...
					Broadcast.toAllOnlinePlayers("¹§Ï²¡¸" + player.getName() + "¡¹ºÍ¡¸" + partner.getName() + "¡¹£¡ËûÃÇ½á»éÁË¡£");
			...
			case "decline":
			{
				...
				player.sendMessage("Äã¾Ü¾ø.");
				partner.sendMessage("ÄãµÄ°éÂÂ¾Ü¾ø£¡.");
